...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_151/sim/ROM2_sin_idct_vecRot_rom_1port_151_scljbpy.v" -work ROM2_sin_idct_vecRot_rom_1port_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ROM2_sin_idct_vecRot.v"                                                                                    
fi
