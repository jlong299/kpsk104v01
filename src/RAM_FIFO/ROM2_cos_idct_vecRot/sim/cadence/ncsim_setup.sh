...
TOP_LEVEL_NAME="ROM2_cos_idct_vecRot"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/ROM2_cos_idct_vecRot_rom_1port_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_151/sim/ROM2_cos_idct_vecRot_rom_1port_151_h3zc72i.v" -work ROM2_cos_idct_vecRot_rom_1port_151 -cdslib ./cds_libs/ROM2_cos_idct_vecRot_rom_1port_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ROM2_cos_idct_vecRot.v"                                                                                                                                                  
fi
