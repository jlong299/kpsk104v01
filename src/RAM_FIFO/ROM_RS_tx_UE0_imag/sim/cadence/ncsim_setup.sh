...
TOP_LEVEL_NAME="ROM_RS_tx_UE0_imag"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/ROM_RS_tx_UE0_imag_rom_1port_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_151/sim/ROM_RS_tx_UE0_imag_rom_1port_151_2ceuyda.v" -work ROM_RS_tx_UE0_imag_rom_1port_151 -cdslib ./cds_libs/ROM_RS_tx_UE0_imag_rom_1port_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ROM_RS_tx_UE0_imag.v"                                                                                                                                              
fi
