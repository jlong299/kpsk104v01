...
# # End of template
# ----------------------------------------
# If ROM_RS_tx_UE0_imag is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.11.17.14:08:51
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ROM_RS_tx_UE0_imag"
}
...
ensure_lib                                  ./libraries/ROM_RS_tx_UE0_imag_rom_1port_151/
vmap       ROM_RS_tx_UE0_imag_rom_1port_151 ./libraries/ROM_RS_tx_UE0_imag_rom_1port_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_151/sim/ROM_RS_tx_UE0_imag_rom_1port_151_2ceuyda.v" -work ROM_RS_tx_UE0_imag_rom_1port_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ROM_RS_tx_UE0_imag.v"                                                                                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ROM_RS_tx_UE0_imag_rom_1port_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ROM_RS_tx_UE0_imag_rom_1port_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
