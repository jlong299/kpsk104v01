...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_151/sim/ROM_RS_tx_UE0_real_rom_1port_151_gplsvky.v" -work ROM_RS_tx_UE0_real_rom_1port_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ROM_RS_tx_UE0_real.v"                                                                                  
fi
