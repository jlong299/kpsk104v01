...
TOP_LEVEL_NAME="RAM_idct_aftIFFT"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/RAM_idct_aftIFFT_ram_2port_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_151/sim/RAM_idct_aftIFFT_ram_2port_151_65vwdsi.v" -work RAM_idct_aftIFFT_ram_2port_151 -cdslib ./cds_libs/RAM_idct_aftIFFT_ram_2port_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM_idct_aftIFFT.v"                                                                                                                                          
fi
