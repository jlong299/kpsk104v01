...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/RAM_idct_aftIFFT_ram_2port_151_65vwdsi.v" -work RAM_idct_aftIFFT_ram_2port_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM_idct_aftIFFT.v"                                                                                
fi
