...
# # End of template
# ----------------------------------------
# If dct_fft is one of several IP cores in your
...
mkdir -p ./libraries/dct_fft_altera_fft_ii_151/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twi3.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twr2.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twi4.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twr3.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twi5.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twr4.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twi1.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twr5.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twr1.hex ./
  cp -f $QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy_opt_twi2.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_gocahoy.vo" -work dct_fft_altera_fft_ii_151 -cdslib ./cds_libs/dct_fft_altera_fft_ii_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dct_fft.v"                                                                                                                                         
fi
