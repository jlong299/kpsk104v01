...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_fft_ii_151/sim/dct_fft_altera_fft_ii_151_2xmofsy.vo" -work dct_fft_altera_fft_ii_151 -cdslib ./cds_libs/dct_fft_altera_fft_ii_151.cds.lib
