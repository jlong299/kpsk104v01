...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../lpm_mult_151/sim/lpm_mult_29_18_lpm_mult_151_qp6wzaq.v" -work lpm_mult_29_18_lpm_mult_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpm_mult_29_18.v"                                                                           
fi
