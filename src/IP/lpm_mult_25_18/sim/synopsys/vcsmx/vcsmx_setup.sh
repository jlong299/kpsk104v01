...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../lpm_mult_151/sim/lpm_mult_25_18_lpm_mult_151_lnncfha.v" -work lpm_mult_25_18_lpm_mult_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpm_mult_25_18.v"                                                                           
fi
