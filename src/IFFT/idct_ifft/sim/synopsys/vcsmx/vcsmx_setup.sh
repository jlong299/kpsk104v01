...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fft_ii_151/sim/idct_ifft_altera_fft_ii_151_7z74xyy.vo" -work idct_ifft_altera_fft_ii_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/idct_ifft.v"                                                                                      
fi
